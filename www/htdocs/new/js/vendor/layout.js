...
var Layout = (function($) {
    ...
    function initTopMenu() {
        ...
        if (!$('ul', ui.topMenuBlock).length) return;
    ...
    function initBanners() {
        ...
        if (!$('a', ui.bannerBlock).length) {
            var $img = $('<img>').attr('src', ui.bannerBlock.attr('data-deafult-image'));
            var $a = $('<a>').attr('href', ui.bannerBlock.attr('data-defualt-href'));
            $a.append($img);
            ui.bannerBlock.append($a);
        }
    ...
    function initPage() {
        ...
        if (typeof($.colorbox) != 'undefined') {
            ...
            $('#cbx_booking1').colorbox({href: '/cms/ru/booking/privacy_policy .node', width: 900, height: 600});
        }
